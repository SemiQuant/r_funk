...
`Rfunk` is an R package that streamlines bioinformatics analyses, providing tools for qPCR analysis, differential expression analysis, and various visualization functions.
...
Analyze qPCR data with the `analyze_pcr()` function:
